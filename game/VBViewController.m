...
- (void)setupGL
{
    ...
    for (int i = 0; i < all_vn; i += 2) {
        v[i] = GLKVector3MultiplyScalar(GLKVector3Subtract(v[i], center), 0.005);
    }
    ...
    glBufferData(GL_ARRAY_BUFFER, [verticesData length], [verticesData bytes], GL_STATIC_DRAW);
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, [indicesData length], [indicesData bytes], GL_STATIC_DRAW);
